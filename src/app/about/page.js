    ...
    <Navbar/>
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-4xl text-indigo-600">Our Misson</h2>
          <p className="mt-6 text-lg leading-8 text-gray-600">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl text-indigo-600">Our Vision</h2>
          <p className="mt-6 text-lg leading-8 text-gray-600">
