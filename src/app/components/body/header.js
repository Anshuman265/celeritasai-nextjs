  ...
  return (
    ...
    <div className="bg-white">
      ...
      <div className="isolate relative pt-14">
        ...
        <div ref={vantaRef} className="mx-auto h-screen py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Get ready for your business & upgrade all aspects
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Harness the Digital Transformation using AI/ML,Data science,Cyber-Security & Blockchain Technologies
            </p>
